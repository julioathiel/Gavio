...
val categoriaDefault = listOf(CategoryDefault(
        "Elige una categoría",
        R.drawable.ic_empty
    )
)
...
val defaultCategoriesGastosList = mutableListOf(
    CategoryGastos(
        "Alquiler / Hipoteca",
        R.drawable.ic_alquiler_hipoteca
    ),
    CategoryGastos(
        "Transporte",
    ...
    CategoryGastos(
        "Alimentos",
        R.drawable.ic_tienda_comestibles
    ),
    CategoryGastos(
        "Tarjeta",
        R.drawable.ic_tarjeta_credito
    ),
    CategoryGastos("Shopping", R.drawable.ic_shopping),
    CategoryGastos(
        "Farmacia",
        R.drawable.ic_local_pharmacy
    ),
