...
@Composable
fun ButtonGastosIngresos(modifier: Modifier = Modifier, onSelectedType: (CategoryTypeEnum) -> Unit) {
    ...
    SingleChoiceSegmentedButtonRow( modifier = modifier) {
        options.forEachIndexed { index, label ->
            ...
            val colorText = if (isSelected) {
                when (label) {
                    CategoryTypeEnum.GASTOS -> MaterialTheme.colorScheme.error
